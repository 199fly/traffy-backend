    ...
    <>
      <div className="uxora-section-padding4 position-relative">
        <div className="container">
            ...
            <div className="col-lg-6">
              <div className="uxora-blog-wrap">
                ...
                <div className="uxora-blog-meta">
                  <ul>
                    <li className="meta-meta">
                      <Link href="/single-blog">Creative</Link>
                    </li>
                    <li>
                      <Link href="/single-blog">June 15, 2025</Link>
                    </li>
                  </ul>
                </div>
                <div className="uxora-blog-content">
                  <Link href="/single-blog">
                    <h3>Building an AI agency from scratch</h3>
                  </Link>
                  <p>Building and scaling a successful agency has never been easy, but with the rise of AI and automation, the game has changed...</p>
                </div>
                <div className="uxora-iconbox-btn">
                  <Link href="/single-blog">
                    <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="uxora-blog-wrap">
                ...
                <div className="uxora-blog-meta">
                  <ul>
                    ...
                    <li>
                      <Link href="/single-blog">June 13, 2025</Link>
                    </li>
                  </ul>
                </div>
                <div className="uxora-blog-content">
                  <Link href="/single-blog">
                    <h3>How to create engaging content</h3>
                  </Link>
                  <p>Content marketing has become a cornerstone of digital marketing strategies, playing a pivotal role in building brand awareness...</p>
                </div>
                <div className="uxora-iconbox-btn">
                  <Link href="/single-blog">
                    <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="uxora-blog-wrap">
                ...
                <div className="uxora-blog-meta">
                  <ul>
                    ...
                    <li>
                      <Link href="/single-blog">June 10, 2025</Link>
                    </li>
                  </ul>
                </div>
                <div className="uxora-blog-content">
                  <Link href="/single-blog">
                    <h3>4 ways to make your AI content good</h3>
                  </Link>
                  <p>I chose the SEO writing niche because it combines my passion for writing with search engine optimization (SEO)..</p>
                </div>
                <div className="uxora-iconbox-btn">
                  <Link href="/single-blog">
                    <svg width="24" height="20" viewBox="0 0 24 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="uxora-blog-wrap">
                ...
                <div className="uxora-blog-meta">
                  <ul>
                    ...
                    <li>
                      <Link href="/single-blog">June 04, 2025</Link>
                    </li>
                  </ul>
                </div>
                <div className="uxora-blog-content">
          ...
          <div className="uxora-pagination center">
            <a className="pagi-btn btn2" href="/single-blog">
              <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.75 0.75L6 6L0.75 11.25" stroke="#001A3D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </a>
            <ul>
              <li><a className="current" href="#">1</a></li>
              <li><a href="/single-blog">2</a></li>
              <li><a href="/single-blog">3</a></li>
            </ul>
            <a className="pagi-btn" href="/single-blog">
              <svg width="7" height="12" viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.75 0.75L6 6L0.75 11.25" stroke="#001A3D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </a>
        ...
        <div className="uxora-pricing-shape6">
