          ...
          <div className="row">
            <div className="col-xxl-4 col-xl-12 col-md-12">
              <div className="uxora-footer-textarea">
                ...
                <p className="uxora-default-data">Join thousands of businesses, educators, and event organizers using our platform for seamless webinars and virtual events.</p>
                <div className="uxora-social-wrap">
                  <ul>
                    <li>
                      <a href="https://www.facebook.com">
                        <svg width="9" height="18" viewBox="0 0 9 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M2.61987 16.7464V9.37041H0.137695V6.49583H2.61987V4.37591C2.61987 1.91577 4.12245 0.576172 6.31707 0.576172C7.36832 0.576172 8.27181 0.654439 8.53511 0.689422V3.26042L7.01302 3.26111C5.81946 3.26111 5.58836 3.82827 5.58836 4.66054V6.49583H8.43488L8.06426 9.37041H5.58836V16.7464H2.61987Z" fill="#F5F4EF"></path>
                        </svg>
                      </a>
                    </li>
                    <li>
            ...
            <div className="col-xxl-3 col-xl-4 col-md-4">
              <div className="uxora-footer-menu menu1 menu1 pl-100">
                <h4>Quick Links</h4>
                <ul>
                  <li>
                    <Link href="/">Home</Link>
            ...
            <div className="col-xxl-2 col-xl-4 col-md-4">
              <div className="uxora-footer-menu menu1 menu2">
                ...
                <ul>
                  ...
                  <li>
                    <a href="#">Uxora Meeting</a>
                  </li>
                  <li>
                    <a href="#">Uxora Webinar</a>
                  </li>
                  <li>
                    <a href="#">Uxora Room</a>
                  </li>
